...
const { tpstudies } = require("centralcommand");
...
var showdatapage = PageMod({
  include: data.url("showdata.html") + "*",
  contentScriptFile: [data.url('js/jquery.min.js'),
                    data.url('js/ICanHaz.min.js'),
                    data.url('js/underscore_min.js'),
...
var liststudies = function(studies){
    // to users!
...
var more_info = function(study){
    ...
    let uri = data.url('index.html' + studyid);
    let tab = switchtab(uri);
};



exports.uipages = uipages;
exports.showdatapage = showdatapage;
exports.showdata = showdata;
exports.liststudies = liststudies;
exports.more_info = more_info;
