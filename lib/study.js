...
const {extensiontracker} = require("extensiontracker"); // TODO, design this
...
const {urlize_addon_path} = require("tputils");
...
let revive = exports.revive = function(id,startbranch){
...
let Study = exports.Study = Class({
  ...
  persist: function() {
    // TODO, what happens on json error here?
  ...
  start_experiment: function() {
    ...
    */
    ...
    if (my.eventselectors) {
        ...
        this.pagemods = [ EventSelector(x,eventselectors_obs_chan) for (x in my.eventselectors) ];
