...
const {Study,survey_defaults,experiment_defaults,revive,STATUS} = require("study");
const tpstudies = require('studytracker').studytracker;
...
let setup_and_run = function(url) {
...
exports.setup_and_run = setup_and_run;
exports.tpstudies = tpstudies;
