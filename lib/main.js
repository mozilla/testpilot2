...
var Study = Class({
  ...
  setStatus: function(data){
    ...
    this.cleartimers();
    this.config.status = new_;
    switch (new_) {
      case S.NEW:  this.NEW(); break;
...
var aaa = {};
aaa.mybanner = tpbanner({msg: 'DESTROY THIS', priority:9});
timers.setTimeout(function() {
    delete aaa.mybanner.nb
    console.log("destroying!");
    delete aaa.mybanner.nb;
    delete aaa.mybanner.notice;
    delete aaa.mybanner},2000);
